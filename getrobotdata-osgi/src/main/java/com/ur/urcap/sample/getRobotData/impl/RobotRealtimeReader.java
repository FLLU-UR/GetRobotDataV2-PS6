...
public class RobotRealtimeReader {
	...
	// Public method that starts reading continuously the Robotdata with a defined frequency
	public void startReadContinuously(int frequency) {
		int waitTime = 1000 / frequency;
		connectSocket();
	...
	// Public method that stops reading continuously.
	public void stopReadContinuously() {
		timer.cancel();
		disconnectSocket();
	}
